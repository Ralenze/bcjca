...
function setup() {
    main_img.src = `gallery/van_west/${van_west_pics[main]}.jpg`;
    next_img.src = `gallery/van_west/${van_west_pics[main + 1]}.jpg`;
}
...
function prev() {
    ...
    if (main > min) {
        prev_img.src = `gallery/van_west/${van_west_pics[main - 1]}.jpg`;
    } else {
        prev_img.src = "";
    }
    main_img.src = `gallery/van_west/${van_west_pics[main]}.jpg`;
